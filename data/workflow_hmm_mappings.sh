...
python make_ss_annotations.py humanKinasesHitsSplitTrimmed.fasta
...
python trim_alignment_split_outside.py \
        ...
        33077 \
        30
python make_ss_annotations.py humanKinasesPkinasePK_Tyr_Ser-ThrAll_no_gapsTrimmed.fasta