...
#print(sorted(uniprot_kinases))
#print(len(uniprot_kinases_short)) #486 human kinase entries
#print(len(uniprot_kinases)) #486 
...
for uniprotid_type, assoc_uniprotids in orth_lst.items():
    ...
    for assoc_uniprotid in assoc_uniprotids[:orth_cutoff[uniprotid_type][2]]: 
