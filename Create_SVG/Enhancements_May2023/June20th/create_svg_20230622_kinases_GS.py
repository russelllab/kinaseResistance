									...
									if feature in klass:
										for vv in doi[k][feature]:	### {'P00519': {'Activating': [['337', '<a href="https://pubmed.ncbi
											if str(residue) in vv:
												...
												if int(i)==int(aligpos[0]):			### -2
													featurecount += 10 * [residue]
												elif int(i)==int(aligpos[4]):			### +2
													featurecount += 10 * [residue]
												elif int(i)==int(aligpos[3]):			### +1
													featurecount += 15 * [residue]
												elif int(i)==int(aligpos[1]):			### -1
													featurecount += 15 * [residue]
												elif int(i)==int(aligpos[2]):
													featurecount += 20 * [residue]
												else:
