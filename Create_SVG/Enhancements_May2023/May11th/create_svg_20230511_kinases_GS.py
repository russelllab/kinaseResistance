   ...
   svg g:hover rect {display: block;}
    ...
    for hlid in highlightsaver:
        ...
        for showfeature in lowertext.split("}"):
            ...
            tspanner = tspanner + """<a href=\""""+linkinformation+"""\" target="_blank"><i class="bi bi-box-arrow-in-up-right"></i><text class="hyper" x='"""+str(cx)+"""' y='"""+str(tspany-28-delty)+"""'><tspan class="text">"""+str(tspanfeaturetext)+"""</tspan></text></a>"""
            tspany += 15
        ...
        circletext = circletext+"""<g xmlns="http://www.w3.org/2000/svg">
          ...
          <rect class="hiss" x='"""+str(cx-5)+"""' y='"""+str(cy-40-delty)+"""' height='"""+str(whiteboxheight)+"""' width='"""+str(len(uppertext)+75)+"""'></rect>
