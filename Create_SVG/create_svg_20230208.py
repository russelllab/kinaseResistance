...
#			print positionalcounter,"\t", identitycontainer, "\t", orires,"\t",identitypercentage,"\t",typuspercentage ,"\t", aminotypes,"\t",oritype
			...
			positionalcounter+=1
	return conservational_dictionary	
# ---------------------------------------------------------------------------------------------------------------------------------------------
def SHOWORDER(seqs, doi, starti, endi, goi):
	...
	return ranking
# ---------------------------------------------------------------------------------------------------------------------------------------------
def create_svg(sequences_dict, positions, colordict, startposition, windowsize, poi):
...
#      				        	dwg.add(dwg.text(letter, insert=(x+5, y+8), text_anchor='middle', dominant_baseline='central', font_size='10px', font_family='Arial', font_weight='bold', fill='white'))
    ...
    viewboxwidth = (distance_end-distance_start+10)*10
    ...
    for category in colors:
	 dwg.add(dwg.rect((x-30, y+7), (60, 14), fill=colors[category]))
    	 dwg.add(dwg.text(category, insert=(x, y+15), text_anchor='middle', dominant_baseline='central', font_size='10px', font_family='Arial', font_weight='bold', fill='black'))
 	 x += 60	
    dwg.save()
...
Konserve 	= conservation_checker("P61586",sequences)
...
create_svg(sequences, positions, colors, 34, 20, "P61586" )	### def create_svg(sequences_dict, positions, colors, startposition, windowsize, poi):
